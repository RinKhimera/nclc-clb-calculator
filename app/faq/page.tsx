...
const faqData = [
  ...
  },
  {
    ...
    answer:
      "En fonction de votre niveau d'études et de votre expérience professionnelle, posséder de solides compétences linguistiques (NCLC 9 ou plus) vous donne des points supplémentaires dans le cadre du Programme des travailleurs qualifiés (fédéral) d'Entrée Express.",
  },
  {
    question: "A combien de points ce bonus me donne-t-il droit ?",
    answer:
      "Si vous possédez un score de NCLC 9 ou plus, vous pouvez obtenir un maximum de 100 points supplémentaires étant titulaire d'une Maîtrise / Master's Degree (+50 points) et justifiant d'au moins 3 années d'expérience professionnelle (+50 points).",
  },
